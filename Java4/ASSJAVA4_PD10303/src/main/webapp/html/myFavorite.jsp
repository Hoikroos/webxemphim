			...
			<div class="row row-cols-2 row-cols-md-4 g-4">
				<div class="col">
					<div class="card bg-dark text-white h-100 video-card">
						<a href="${pageContext.request.contextPath}/videochitiet"> <img
							src="mbappe.jpg" class="card-img-top" alt="Thế Giới Ma Quái 2">
							<div class="play-icon">
								<i class="fas fa-play"></i>
							</div>
						</a>
						<div class="card-body">
							<h6 class="card-title text-uppercase">Thế Giới Ma Quái 2</h6>

...
<body>
    ...
    <form id="shareForm">
        <div class="card" style="width: 500px">
            ...
            <div class="col">
                <div class="p-2">
                    <label for="shareemail" class="form-label">Your friend's email?</label>
                    <input type="email" class="form-control border border-warning" name="shareemail" id="shareemail"
                        placeholder="Vui lòng nhập email" required />
                </div>
            </div>
            <!-- Add hidden input to store video ID -->

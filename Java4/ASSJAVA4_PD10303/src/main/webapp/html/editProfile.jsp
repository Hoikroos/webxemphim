			...
			<div class="form-container border-2">
				...
				<form class="form" action="editProfile" method="post">
					<input type="text" class="input" name="username" id="username"
						value="${user.id}" readonly> <input type="password"
						class="input" name="password" id="password"
						value="${user.password}" readonly> <input type="text"
						class="input" name="fullname" id="fullname"
						value="${user.fullname}"> <input type="email"
						class="input" name="email" id="email" value="${user.email}">
